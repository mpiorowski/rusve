...
func (x *PostId) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_posts_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x38, 0x0a, 0x06, 0x50, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x70,
...
func file_posts_proto_init() {
	...
	file_posts_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
